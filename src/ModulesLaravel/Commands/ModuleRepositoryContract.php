...
class ModuleRepositoryContract extends Command
{
    use CommandTrait;
    /**
     ...
     * @var string
     */
    protected $description = 'Make a new Repository Contract extending of Core module';
    ...
    public function handle()
    {
        ...
        $toDirectory        = $moduleDirectory . $module . '/Contracts/Repositories';
        ...
        $this->info('The Module ' . $module .' has been received a new repository contract: ' . $name . '. Be happy!');
    }
}
